...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"bgcolor" : [ 0.090196078431373, 0.670588235294118, 0.847058823529412, 0.0 ],
					"bubble" : 1,
					"id" : "obj-42",
					"maxclass" : "comment",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1061.5, 921.0, 150.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 357.0, 89.0, 150.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1178.0, 868.0, 45.0, 22.0 ],
					"text" : "store 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1126.0, 868.0, 45.0, 22.0 ],
					"text" : "store 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1075.0, 868.0, 45.0, 22.0 ],
					"text" : "store 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1020.0, 963.0, 29.5, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 312.0, 129.0, 29.5, 22.0 ],
					"text" : "3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1020.0, 930.0, 29.5, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 312.0, 96.0, 29.5, 22.0 ],
					"text" : "2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1020.0, 898.0, 29.5, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 312.0, 64.0, 29.5, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1261.0, 917.0, 33.0, 22.0 ],
					"text" : "read"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1260.0, 893.0, 34.0, 22.0 ],
					"text" : "write"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 1121.0, 822.0, 56.0, 22.0 ],
					"text" : "autopattr",
					"varname" : "u193004074"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1006.0, 822.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1075.0, 963.0, 123.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 613.0, 341.0, 175.0, 116.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 813.0, 193.5, 314.0, 116.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 248.0, 127.0, 170.0, 116.0 ],
					"varname" : "bp.LFO2",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 638.0, 483.0, 150.0, 20.0 ],
					"text" : "Filter"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 506.0, 518.0, 558.0, 223.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1038.0, 348.0, 150.0, 20.0 ],
					"text" : "ADSR"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1047.0, 323.0, 150.0, 20.0 ],
					"text" : "Envelope"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1038.0, 373.0, 267.0, 116.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 825.0, 885.0, 150.0, 20.0 ],
					"text" : "Beap VCA"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 706.0, 842.0, 113.0, 116.0 ],
					"varname" : "bp.VCA",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 569.0, 42.0, 578.0, 117.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 370.0, 129.0, 578.0, 117.0 ],
					"varname" : "bp.Keyboard",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 146.0, 399.0, 150.0, 20.0 ],
					"text" : "Beap Spectral Scope"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 0.0, 421.0, 435.0, 214.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 825.0, 1037.0, 150.0, 20.0 ],
					"text" : "beap stereo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 653.0, 989.0, 148.0, 116.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 766.0, 367.0, 148.0, 116.0 ],
					"varname" : "bp.Stereo",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 285.0, 874.0, 150.0, 20.0 ],
					"text" : "Beap oscilloscope"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 825.0, 348.0, 150.0, 20.0 ],
					"text" : "Beap oscillator "
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 370.0, 269.0, 372.0, 214.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 34.0, 98.0, 150.0, 20.0 ],
					"text" : "VCV Rack - Beap"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 34.0, 42.0, 150.0, 48.0 ],
...
, 			{
				"name" : "mySynth.json",
				"bootpath" : "~/Desktop/Interactive Sound/Beap Synth",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
