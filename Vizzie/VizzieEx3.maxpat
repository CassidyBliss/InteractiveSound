...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 860.0, 212.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 379.0, 570.0, 208.0, 113.0 ],
					"prototypename" : "pixl",
					"varname" : "analyzr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 607.0, 139.0, 150.0, 20.0 ],
					"text" : "slider"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 687.0, 415.0, 558.0, 223.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 694.0, 662.0, 148.0, 116.0 ],
					"varname" : "bp.Stereo",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 771.0, 268.0, 314.0, 116.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 353.0, 703.0, 186.0, 108.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 640.0, 290.0, 111.0, 34.0 ],
					"text" : "you can use a float\ninterger is ignored"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 13.0, 70.0, 348.0, 158.0 ],
					"prototypename" : "pixl",
					"varname" : "playr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 39.0, 582.0, 230.0, 208.0 ],
					"prototypename" : "pixl",
					"varname" : "viewr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 574.0, 295.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 551.0, 220.0, 121.0, 34.0 ],
					"text" : "all vizzie control values are 0. to 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 479.0, 295.0, 50.0, 36.0 ],
					"text" : "0.503937"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 411.0, 206.0, 97.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 395.0, 129.0, 186.0, 40.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 537.0, 180.0, 50.0, 22.0 ],
					"text" : "64"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 392.0, 44.0, 73.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 384.0, 402.0, 208.0, 130.0 ],
					"prototypename" : "pixl",
					"varname" : "brcosr",
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-28::obj-14" : [ "umenu[3]", "umenu", 0 ],
			"obj-28::obj-22" : [ "range[7]", "range", 0 ],
			"obj-28::obj-24" : [ "pictctrl[73]", "pictctrl[6]", 0 ],
			"obj-28::obj-30" : [ "pictctrl[71]", "pictctrl[5]", 0 ],
			"obj-28::obj-32" : [ "pictctrl[72]", "pictctrl[7]", 0 ],
			"obj-28::obj-39" : [ "pictctrl[74]", "pictctrl[8]", 0 ],
			"obj-28::obj-41" : [ "pictctrl[70]", "pictctrl[10]", 0 ],
			"obj-28::obj-52::obj-23" : [ "gswitch2[3]", "gswitch2", 0 ],
			"obj-28::obj-94" : [ "umenu[2]", "umenu", 0 ],
			"obj-32::obj-106" : [ "CV3", "CV3", 0 ],
			"obj-32::obj-107" : [ "Linear", "Linear", 0 ],
			"obj-32::obj-11" : [ "PWM", "PWM", 0 ],
			"obj-32::obj-129" : [ "CV2", "CV2", 0 ],
			"obj-32::obj-36" : [ "PW", "PW", 0 ],
			"obj-32::obj-4" : [ "Waveform", "Waveform", 0 ],
			"obj-32::obj-45" : [ "FreqMode", "FreqMode", 0 ],
			"obj-32::obj-46" : [ "Offset", "Offset", 0 ],
			"obj-32::obj-51" : [ "Freq", "Freq", 0 ],
			"obj-32::obj-53" : [ "Mute", "Mute", 0 ],
			"obj-33::obj-22" : [ "Mute[1]", "Mute", 0 ],
